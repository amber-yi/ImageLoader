...
) : GPUFilterTransformation<GPUImagePixelationFilter?>(context, pool, GPUImagePixelationFilter()) {
    constructor(context: Context?, pixel: Float) : this(
        context,
